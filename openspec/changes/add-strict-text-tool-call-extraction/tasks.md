...
- [ ] 1.3 Reject invalid JSON, multiple calls, missing `name`, non-object `arguments`, and assistant-authored `<tool_result>`.
...
- [ ] 3.3 Add regression tests for split streaming text, user/toolResult tag injection, and inactive tool names using the normal error result path.
