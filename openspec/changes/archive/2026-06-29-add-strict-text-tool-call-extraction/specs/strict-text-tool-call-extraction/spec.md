...
Accepted synthetic tool calls MUST use a `toolCall.id` with a `text_tool_call_` prefix and a unique suffix, and MUST be unique across the conversation history.
