...
- [ ] 1.2 Add `toolProtocol` to settings with valid values `native`, `text`, and `auto`.
- [ ] 1.3 Resolve protocol precedence as CLI, settings, then `native`.

## 2. CLI And Docs

- [ ] 2.1 Add `--tool-protocol native|text|auto` parsing and diagnostics.
...
- [ ] 3.1 Add CLI args tests for valid and invalid protocol values.
